...
1. Click the pencil icon to edit the policy for which you want your registration hook to be associated with.

1. Select your hook from the dropdown menu for **Use the following inline hook** under the options for **For new users**. If you have created multiple Registration Inline Hooks, you should see all of them displayed here.
